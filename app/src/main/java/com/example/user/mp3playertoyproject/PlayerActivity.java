...
public class PlayerActivity extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frg_player, container, false);
        ...
        if (MainActivity.playingLiked)
            selectedMusicSetting(MainActivity.likeList, LikeAdapter.position);
        else
            selectedMusicSetting(MainActivity.musicDataList, MusicAdapter.position);
